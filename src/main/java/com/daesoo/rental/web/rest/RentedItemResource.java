package com.daesoo.rental.web.rest;

import com.daesoo.rental.repository.RentedItemRepository;
import com.daesoo.rental.service.RentedItemService;
import com.daesoo.rental.service.dto.RentedItemDTO;
import com.daesoo.rental.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.daesoo.rental.domain.RentedItem}.
 */
@RestController
...
public class RentedItemResource {
    ...
    private static final String ENTITY_NAME = "rentedItem";
